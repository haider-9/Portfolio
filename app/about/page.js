...
import { FaChalkboardTeacher, FaUniversity, FaCode, FaStar, FaQuoteLeft, FaMugHot } from "react-icons/fa";
...
const AboutPage = () => {
  const funFacts = [
    ...
    { emoji: "🌌", text: "Astronomy enthusiast who can name more stars than celebrities" },
    { emoji: "🧮", text: "Believes Euler's identity is nature's perfect love letter" },
    { emoji: "🐍", text: "Python lover (the language, not the snake)" },
  ];

  const codingJourney = [
    { year: "2018", event: "First 'Hello World' (followed by many confused faces)" },
    { year: "2020", event: "Discovered Stack Overflow - my digital savior" },
    { year: "2022", event: "Built first full-stack app (and learned humility)" },
    { year: "2023", event: "Fell in love with TypeScript (it's complicated)" },
  ];

  const highlights = [
    { number: "2+", label: "Years Coding", icon: <FaCode className="text-blue-500" /> },
    { number: "10+", label: "Projects Built", icon: <SiReact className="text-blue-500" /> },
    { number: "10+", label: "GitHub Repos", icon: <SiGit className="text-blue-500" /> },
    { number: "1K+", label: "Tea Cups", icon: <FaMugHot className="text-blue-500" /> },
  ];

  const skills = [
    { name: "React", icon: <SiReact size={24} />, category: "Frontend", color: "#61DAFB" },
    { name: "Next.js", icon: <SiNextdotjs size={24} />, category: "Frontend", color: "#ffffff" },
    { name: "Redux", icon: <SiRedux size={24} />, category: "State Management", color: "#764ABC" },
    { name: "TypeScript", icon: <SiTypescript size={24} />, category: "Language", color: "#3178C6" },
    { name: "Node.js", icon: <SiNodedotjs size={24} />, category: "Backend", color: "#339933" },
    { name: "MongoDB", icon: <SiMongodb size={24} />, category: "Database", color: "#47A248" },
    { name: "Firebase", icon: <SiFirebase size={24} />, category: "Backend", color: "#FFCA28" },
    { name: "Python", icon: <SiPython size={24} />, category: "Language", color: "#3776AB" },
    { name: "Tailwind CSS", icon: <SiTailwindcss size={24} />, category: "Styling", color: "#38B2AC" },
    { name: "JavaScript", icon: <SiJavascript size={24} />, category: "Language", color: "#F7DF1E" },
    { name: "Git", icon: <SiGit size={24} />, category: "Version Control", color: "#F05032" },
    { name: "Postman", icon: <SiPostman size={24} />, category: "API Testing", color: "#FF6C37" },
    { name: "LaTeX", icon: <SiLatex size={24} />, category: "Documentation", color: "#008080" },
    { name: "Jupyter", icon: <SiJupyter size={24} />, category: "Data Science", color: "#F37626" },
    { name: "VS Code", icon: <VscVscodeInsiders size={24} />, category: "IDE", color: "#007ACC" },
    { name: "Vercel", icon: <SiVercel size={24} />, category: "Deployment", color: "#000000" },
  ];

  const interests = [
    { name: "Astronomy", icon: <GiGalaxy size={24} />, description: "Exploring celestial bodies and cosmic phenomena" },
    { name: "Mathematics", icon: <TbMathXDivideY2 size={24} />, description: "Problem-solving and abstract reasoning" },
    { name: "Anime", icon: <FaStar size={24} />, description: "Japanese animation and storytelling" },
    { name: "Web Development", icon: <FaCode size={24} />, description: "Creating interactive digital experiences" },
  ];

  const education = {
    university: "Computer Science Student",
    description: "Pursuing my passion for technology and mathematics through formal education while applying theoretical knowledge to practical projects."
  };
    ...
    <main className="pt-24 min-h-screen px-4 sm:px-6 md:px-10 ">
          ...
          <div className="space-y-8 relative">
            ...
            {codingJourney.map((item, index) => (
              <motion.div
                ...
                className={`relative flex ${index % 2 === 0 ? 'sm:flex-row' : 'sm:flex-row-reverse'} items-start gap-4`}
              >
      ...
      >
        ...
        >
          ...
          or explaining to friends why spaces are superior to tabs in code editors.
        </motion.p>
      ...
      >
        <div className="relative rounded-3xl p-8 sm:p-10 overflow-hidden bg-zinc-50 dark:bg-zinc-800/50 shadow-sm border border-zinc-200 dark:border-zinc-700">
          ...
          <div className="space-y-6 text-zinc-700 dark:text-zinc-300">
            ...
            <p className="leading-relaxed">
              I approach problems like I approach my tea - methodically, with patience, 
              and with the understanding that the first attempt is usually too hot to handle.
            </p>

            <p className="leading-relaxed">
              My coding style? Imagine if Marie Kondo wrote JavaScript. 
              If it doesn't spark joy (or at least not cause errors), it doesn't belong in the codebase.
            </p>
